...
TMP_RUN_LOG="$(mktemp -t tacact_run_main_9gpu_fastio_XXXX.log)"
...
bash run_main_9models_9gpu_fastio.sh >"${TMP_RUN_LOG}" 2>&1 &
TRAIN_PID=$!
...
python watch_main_9models_5gpu.py --run_root "${run_root}" --gpu_count 9
